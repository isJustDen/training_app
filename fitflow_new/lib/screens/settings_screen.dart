            ...
            children: [
              ...
              Card(
                child: ListTile(
                  ...
                  title: const Text('Перспективы на обновления в будущем'),
                  subtitle: const Text('Предложения и жалобы принимаются по адресу den.work.zav@gmail.com'),
                  trailing: const Icon(Icons.chevron_right_outlined),
                  onTap: _futuresUpdates,
                ),
              ),
...
// ДИАЛОГ СБРОСА ШАБЛОНОВ
  ...
  //ПЕРСПЕКТИВЫ НА ГРЯДУЩИЕ ОБНОВЛЕНИЯ
  void _futuresUpdates() {
    showDialog(
      context: context,
      builder: (context) => AlertDialog(
        title: Row(
          children: [
            Icon(Icons.tips_and_updates, color: Colors.pink.shade100, size: 28),
            const SizedBox(width: 8),
            const Text('Перспективы на будущее'),
          ],
        ),
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: Row(
                  children: [
                    Icon(Icons.recommend_outlined, color: Colors.green.shade400, size: 16),
                    const SizedBox(width: 8),
                    const Expanded(
                      child: Text(
